...
Распакуйте установленный архив в удобном место и добавьте путь к папке bin в PATH. Это можно сделать так:
зайти по порядку в система\дополнительные параметры системы\переменные среды, найти PATH и нажать изменить, добавить соответствующий путь.
...
Для начала скачайте драйвер для stm32 [здесь](https://www.st.com/en/development-tools/stsw-link009.html#get-software).
